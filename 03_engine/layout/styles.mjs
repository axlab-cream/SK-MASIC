...
export const STYLES = {
  ...
  'refine-premium': {
    ...
    headWeight: 700, headFace: 'kr', band: false, logoPlate: true, dark: true,
  },
  ...
  'refine-ice-campaign': {
    ...
    priceInk: '#1C6F98', badgeBg: '#14516F', badgeInk: '#FFFFFF',
    headWeight: 700, headFace: 'kr', band: true, bandBg: '#D9F1FF', bandInk: '#173042', bandTag: 'transparent', bandTagInk: '#1C5570', logoPlate: false,
  },
};
